const state = {
      ...
      <div class='card shadow-sm task__card'>
        ...
        <div class='card-body'>
          ...
          <div class="form-check" style="position: absolute; bottom: 10px; right: 10px;">
            <input class="form-check-input" type="checkbox" id="completedCheckbox-${id}" onchange="toggleCompletion.apply(this, arguments)">
            <label class="form-check-label" for="completedCheckbox-${id}">
              Completed
            </label>
          </div>
        </div>
  ...
  //local storage (Browsers storage)
